...
if __name__ == '__main__':
  ...
  folder = os.path.join('2003', 'NUR')
  op_count = safemd (folder, 0, op_count)

  local_file = os.path.join('2003', 'NUR', 'nur20031030min.min')
  op_count = getfile ('https://imag-data.bgs.ac.uk/GIN_V1/GINServices?Request=GetData&format=IAGA2002&testObsys=0&observatoryIagaCode=NUR&samplesPerDay=1440&publicationState=adj-or-rep&recordTermination=UNIX&dataStartDate=2003-10-30&dataDuration=1', local_file, n_retries, 1, gin_username, gin_password, proxy_address, n_folders, n_downloads, op_count)
  local_file = os.path.join('2003', 'NUR', 'nur20031031min.min')
  op_count = getfile ('https://imag-data.bgs.ac.uk/GIN_V1/GINServices?Request=GetData&format=IAGA2002&testObsys=0&observatoryIagaCode=NUR&samplesPerDay=1440&publicationState=adj-or-rep&recordTermination=UNIX&dataStartDate=2003-10-31&dataDuration=1', local_file, n_retries, 2, gin_username, gin_password, proxy_address, n_folders, n_downloads, op_count)
